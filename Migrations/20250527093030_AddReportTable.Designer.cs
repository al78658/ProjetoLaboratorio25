...
namespace ProjetoLaboratorio25.Migrations
{
    ...
    [Migration("20250527093030_AddReportTable")]
            ...
            modelBuilder.Entity("ProjetoLaboratorio25.Models.Notificacao", b =>
                {
                    ...
                    b.Property<int?>("EmparelhamentoId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjetoLaboratorio25.Models.Notificacao", b =>
                {
                    ...
                    b.HasOne("ProjetoLaboratorio25.Models.EmparelhamentoBase", "Emparelhamento")
                        .WithMany()
                        .HasForeignKey("EmparelhamentoId");

                    b.Navigation("Competicao");

                    b.Navigation("Emparelhamento");
                });
